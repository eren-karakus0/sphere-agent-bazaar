...
export class Logger {
  ...
  debug(msg: string, ...rest: unknown[]): void { this.log('debug', msg, ...rest); }
  info(msg: string, ...rest: unknown[]): void { this.log('info', msg, ...rest); }
  warn(msg: string, ...rest: unknown[]): void { this.log('warn', msg, ...rest); }
  error(msg: string, ...rest: unknown[]): void { this.log('error', msg, ...rest); }
}
